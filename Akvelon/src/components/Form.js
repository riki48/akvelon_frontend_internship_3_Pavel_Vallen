        ...
        <div className="wrapper">
                ...
                <div className="form-wrapper">
                    <form noValidate action="" onSubmit={submitHandler} className="form">
                        <label >Name:</label>
                            <input type="text" value={name} onChange={nameHandler} className="formInput"  />
                        <label >Email:</label>
                          <input type="email" value={email} onChange={emailHandler} className="formInput" />
                        <label >Password:</label>
                         <input type="text" value={pass} onChange={passHandler} className="formInput"/>
